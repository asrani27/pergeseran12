...
<div class="transition-all duration-300">
    ...
    <div class="mb-6">
        <div class="bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2">Dashboard Pimpinan SKPD</h1>
                    <p class="text-amber-100">Selamat datang, {{ Auth::user()->name }}</p>
                </div>
                <div class="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                    <p class="text-sm font-medium">{{ $skpd->nama ?? 'SKPD' }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $pengajuan->where('status_kepala_skpd', 1)->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-gray-500 text-sm">Sudah Disetujui</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $pengajuan->where('status_kepala_skpd', 2)->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-xl">
            ...
            <p class="text-sm text-gray-500">Daftar pengajuan pergeseran dari SKPD Anda</p>
        </div>
        <div class="p-6">
                            ...
                            @foreach($pengajuan as $item)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @elseif($item->status_kepala_skpd == 3)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                        <a href="{{ route('pimpinan.pergeseran.show', $item->id) }}"
